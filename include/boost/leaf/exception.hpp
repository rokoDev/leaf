...
[[noreturn]] void throw_exception( E && ... e )
{
    ...
    // via BOOST_LEAF_THROW_EXCEPTION. To intercept exceptions thrown via
    // BOOST_LEAF_THROW_EXCEPTION or boost::leaf::throw_exception, set a
    // breakpoint inside boost::leaf::leaf_detail::throw_exception_impl.
